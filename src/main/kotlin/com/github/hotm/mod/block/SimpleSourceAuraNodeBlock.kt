...
class SimpleSourceAuraNodeBlock(settings: Settings) : Block(settings), AuraNodeBlock {
    companion object {
    ...
    override fun getBlockNodes(world: ServerWorld, pos: BlockPos, state: BlockState): Collection<BlockNode> =
        listOf(SimpleSourceAuraBlockNode)

    override fun getSelectedBlockNode(context: ItemUsageContext): BlockNode = SimpleSourceAuraBlockNode
