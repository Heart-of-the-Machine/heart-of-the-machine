...
class BasicSourceAuraNode(
...
) : AbstractMetaBlock(Type, access, updateListener, pos), SourceAuraNode, DependantAuraNode {

    companion object {
        private val NET_PARENT = MetaBlock.NET_ID.subType(
            BasicSourceAuraNode::class.java,
            HotMConstants.str("basic_source_aura_node")
        )
    ...
    object Type : MetaBlockType<BasicSourceAuraNode> {
