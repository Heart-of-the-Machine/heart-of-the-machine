...
class CollectorDistributorAuraNodeBlock(settings: Settings) : Block(settings), AuraNodeBlock {
    companion object {
    ...
    override fun getBlockNodes(world: ServerWorld, pos: BlockPos, state: BlockState): Collection<BlockNode> =
        listOf(CollectorDistributorAuraBlockNode)

    override fun getSelectedBlockNode(context: ItemUsageContext): BlockNode = CollectorDistributorAuraBlockNode
